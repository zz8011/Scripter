...
| 模块 | 状态 | 说明 |
|------|------|------|
| **数据库设计** | ✅ 完成 | Drizzle ORM，8 张表（users, projects, characters, scenes, worldview, storyboards, ai-conversations, juling-configs, milestones） |
| **剧本编辑器** | ✅ 完成 | TipTap 编辑器，支持场景/人物/对白/动作/括号说明，Tab 切换格式，实时格式验证 |
| **Dashboard** | ✅ 完成 | 项目列表、统计卡片、创建/删除项目 |
| **API 路由** | ✅ 完成 | projects, scenes, characters, ai, auth, worldview, storyboards 等 |
| **智谱 AI 集成** | ✅ 完成 | lib/zhipu.ts，支持流式和非流式调用 |
| **状态管理** | ✅ 完成 | Zustand (editorStore) |
| **UI 组件** | ✅ 完成 | LeftSidebar, AISidebar, SceneCard, MainLayout 等 |

### 🚧 待完善功能

| 模块 | 优先级 | 说明 |
|------|--------|------|
| **AI 对话系统** | 🔥 高 | 剧灵生辰八字系统、原子化技能、不打扰原则 |
| **导出功能** | 🔥 高 | PDF/Word/Text 导出，制作准备文档 |
| **认证系统** | 🔥 高 | Casdoor 集成、用户登录/注册 |
| **人物/场景管理** | 🟡 中 | 看板视图、拖拽排序、AI 生成人设 |
| **世界观编辑** | 🟡 中 | 多维设定编辑、结构化展示 |
| **分镜系统** | 🟡 中 | 四栏排版、运镜建议 |
